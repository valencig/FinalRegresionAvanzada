...
**Objetivos**
Nos proponemos realizar un estudio para determinar los factores que influyen en la tasa de suicidios  de México 
...
### Visión mundial
![Visión mundial](mundial_vision.png)


 En los años 1985 a 1995 el número de suicidios mundial por cada 100,000 personas tuvo una tendencia lineal creciente alcanzando su máximo en 1995 de 15 y comenzando a decrecer durante los siguientes años hasta alcanzar en el año 2015 el punto mínimo en 11.
 
 ![Genero](munidal_genero.png)
...
![Mexico](mex_suicidios.png)

El número de suicidios por cada 100,000 personas ha incrementado ligeramente a través de los años.
 
![Mexico genero](mex_genero.png) 
El género masculino tiene mayor número de suicidios por cada 100,000 personas, este incrementa ligeramente a través del tiempo, por otro lado el género femenino se comporta casi constante alrededor de uno.

![Porcentaje GDP](mex_gdp.png)


El porcentaje de GDP invertido en salud incrementa a través de los años teniendo un ligero decremento en 1996 para volver a incrementar.

![Esperanza de vida](mex_esperanzaV.png)

La esperanza de vida se comporta lineal creciente hasta el año 2004 donde alcanza su punto máximo, se comporta constante durante un  año para decrecer ligeramente hasta alcanzar el mismo nivel que en el año 2003 en el año 2013.

![Alcoholismo](mex_alcoholismo.png)


El porcentaje de alcoholismo decreció durante 1990 a 1995  alcanzando en este año su punto mínimo para crecer hasta el año 2000 y volver a decrecer ligeramente hasta el 2005 para finalmente crecer lentamente.

![Trastorno ansiedad](mex_ansiedad.png)


![Trastornos mentales](mex_trastornos.png)


El porcentaje de la población con trastornos mentales se comporta de manera similar al porcentaje con trastornos de ansiedad, lo único que cambia es la escala de estos. El comportamiento es creciente hasta el año 2005 donde comienza comportarse constante alrededor de 10.8% en trastornos mentales y 3.18% en trastornos de ansiedad.
